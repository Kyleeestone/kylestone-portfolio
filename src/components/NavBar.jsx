...
const Navbar = () => {
  ...
  return (
    <nav
      className={`font-roboto font-bold fixed top-5 left-1/2 transform -translate-x-1/2 w-[90%] md:w-[70%] lg:w-[50%] p-3 ${
        darkMode ? "bg-gray-800" : "bg-white"
      } backdrop-blur-lg shadow-lg rounded-full flex justify-between items-center z-50 transition-all duration-300`}
    >
      {/* Logo Section */}
      ...
      <button
        className={`relative w-14 h-7 flex items-center ${
          darkMode ? "bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900" : "bg-gradient-to-r from-gray-200 to-gray-300"
